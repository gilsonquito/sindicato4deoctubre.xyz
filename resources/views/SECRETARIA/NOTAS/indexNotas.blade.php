    ...
    <body>
            <div class="container-fluid p-2"><!--digeneral-->    
                    <nav class="navbar navbar-expand-lg navbar-light bg-light justify-content-center">
                        <a class="navbar-brand text-success" href="#">Notas de Estudiantes</a>
                    </nav>
                    <div class="container-fuid">
                                <ul class="nav nav-tabs py-1" id="myTab" role="tablist">
                                    ...
                                    <li class="nav-item" onclick="cargarSelectPeriodos()">
                                        <a class=" nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false"><i class="fa fa-search text-success mr-2" aria-hidden="true"></i>Consultar notas</a>
                                    </li>
                                </ul>
            ...
            <script type="text/javascript"> //cargar tabla en el index
                $(document).ready(function(){
                    var notas=$('#tabla-notasDocente').DataTable({
                        ...
                        serverSide:true,
                        ajax:{
                            url:"{{route('notasSecretaria.indexSecretaria')}}",
                        },
                        columns:[
                            {data:'nombre_mod'},
                            {data:'fechaini'},
            ...
            <script>
                $(document).ready(function(){    
                    $('#SelPeriodoAcademico').on('change', function(e){//cargar  cursos
                        ...
                        $.get('/notasSecretaria/selectCursosSecretaria/'+periodoacad,function(data) {
                                $('#SelCursos').empty();
                    ...
                    $('#SelCursos').on('change', function(e){//cargar  modulos
                        ...
                        $.get('/notasSecretaria/selectModulosSecretaria/'+periodoA+"/"+curso,function(data) {
                                $('#SelModulos').empty();
                                $('#SelModulos').append('<option value="" disabled="true" selected="true">Elija un módulo</option>');
                                $.each(data, function(fetch, regenciesObj){
                    ...
                    $('#SelModulos').on('change', function(e){//cargar periodo de horarios
                        ...
                        $.ajax({
                                url:'/notasSecretaria/tablaEstudiantesSecretaria/'+periodoA+"/"+cursoL+"/"+idModulo,
            ...
            <script>
                  function cargarSelectPeriodos(){//cargar periodos academicos
                            ...
                            $.get('/notasSecretaria/selectPeriodosSecretaria',function(data) {
