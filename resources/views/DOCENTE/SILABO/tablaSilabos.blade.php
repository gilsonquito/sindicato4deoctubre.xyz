                                        ...
                                        <tbody class="text-center text-dark">         
                                            @foreach ($silabos as $silabo)
                                                <tr>    
                                                    ...
                                                    <td class="py-2 font-weight-bold text-uppercase font-italic text-muted">{{$silabo->nombre_mod}}</td>
                                                    ...
                                                    <td class="py-2 font-weight-bold text-muted">{{$silabo->nombre_paralelo}}</td>   
                                                    <td class="py-2">
