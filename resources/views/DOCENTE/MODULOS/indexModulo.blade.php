    ...
    <body>
            <div class="container-fluid p-2"><!--digeneral-->    
                    <nav class="navbar navbar-expand-lg navbar-light bg-light justify-content-center">
                        <a class="navbar-brand text-success" href="#">Modulos docente</a>
                    </nav>
                    <div class="container-fuid">
                                ...
                                <div class="" id="">
                                                ...
                                                <hr>
                                                <nav class="navbar navbar-expand-lg navbar-light bg-light justify-content-center">
                                                    <a class="navbar-brand text-dark" href="#">Lista de módulos</a>
                                                </nav>
                                                <div id="tabla-listaModulos">
                                                </div>
                                    <!--</form>-->
            ...
            <script>
                $(document).ready(function(){    
                    $('#SelPeriodoAcademico').on('change', function(e){//cargar  cursos
                        ...
                        $.get('/modulosDocente/selectCursos/'+periodoacad,function(data) {
                                $('#SelCursos').empty();
                        ...
                        $.ajax({
                            url:'/modulosDocente/tablaModulosPeriodos/'+periodoacad,
                                success : function(data){
                                    setTimeout(function(){
                                        $('#tabla-listaModulos').empty().append($(data));
                                    }
                                    );
                                }
                        });                                                         
                    ...
                    $('#SelCursos').on('change', function(e){//cargar  modulos
                        ...
                        $.ajax({
                            url:' /modulosDocente/tablaModulosPeriodosCursos/'+periodoA+"/"+curso,
                                success : function(data){
                                    setTimeout(function(){
                                        $('#tabla-listaModulos').empty().append($(data));
                                    }
