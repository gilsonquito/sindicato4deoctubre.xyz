        ...
        <div id="todoContenido">
            <div class="py-2">
                <nav class="navbar navbar-expand-lg navbar-light bg-light justify-content-center">
                        <a class="navbar-brand text-success" href="#">Gestión Avances Académicos - Docente</a>
                </nav>
            </div>  
            ...
            <div class="p-3 border ">
                <div class="justify-content" >
                    <div class="row align-items-center">
                        <div class="col-md-11">
                            <h5 class="text-left font-weight-normal text-muted" href="#">Datos Módulo</h5> 
                        </div>
                        <div class="col-md-1">
            ...
            <div class="p-3 border ">
                <div class="justify-content" >
                    <div class="row align-items-center">
                        <div class="col-md-11">
                            <h5 class="text-left font-weight-normal text-muted" href="#">Avance Académico</h5> 
                        </div>
                        <div class="col-md-1">
                            <button class="btn btn-outline-light" onclick="esconderAvanceAcademico()" title="Ocultar Datos avance academico"><i id="btnClose2" class="fa fa-chevron-up text-secondary" aria-hidden="true"></i></button>
                        </div>
                    </div> 
                    <hr color="" class="border border-success w-100 p-0">
                    <div id="seccionAvanceAcademico"  >
                    </div>
                </div>
            </div>
            <br>
        ...
        <div class="container">
            ...
            <script>//silabo sleccionado
                                ...
                                {   
                                        ...
                                        {  
                                            ...
                                            {                                            
                                                ...
                                                $.ajax({
                                                    url:'/avancesacademico/ingresarAvanceVista/'+str,
                                                        success : function(data){
                                                            setTimeout(function(){
                                                                $('#seccionAvanceAcademico').empty().append($(data));
                                                            }
                                                            );
                                                        }
                                                });
                ...
                <script>
                    ...
                    function esconderAvanceAcademico() {
                        var x = document.getElementById("seccionAvanceAcademico");
                        if (x.style.display === "none") {
                            x.style.display = "block";
                        } else {
                            x.style.display = "none";
