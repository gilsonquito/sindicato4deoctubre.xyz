...
<html lang="en">
    <head>
        ...
        <link href="{{asset('css/datosDirector.css')}}" rel="stylesheet">
        <title>Datos director</title>
    </head>
    <body>
        <div class="container-fluid p-2"><!--digeneral-->
            <nav class="navbar navbar-expand-lg navbar-light bg-light p-2">
                            <i class="fa fa-pencil-square-o  mr-3 lead  text-DARK" aria-hidden="true"></i>
                            <a class="navbar-brand font-weight-bold  text-warning" href="#">Datos director</a>
            </nav>
            @foreach ($docentes as $docente)
            <form id="datosDirectorForm" class="py-4">
                @csrf                               
    ...
    <!--cambiar foto-->
            ...
            <form id="avatarForm" action="{{url('/director/changeImage')}}" method="POST" enctype="multipart/form-data" class="p-4">
                @csrf  
                <div class="row justify-content-center p-2">
                    <div class="col-md-6 px-2  justify-content-center text-left">
        ...
        <script>//actualizar cambios realizados                
                $('#datosDirectorForm').submit(function(e){
                    e.preventDefault();
                    ...
                    $.ajax({
                                url:"{{route('director.actualizarDirector')}}",
                                type:"POST",
                                data:{
                                        id_doc:id_doc2,                                        
                                        name:name2,                                       
