...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'solodirector' => \App\Http\Middleware\SoloDirector::class,
	    'soloinspector' => \App\Http\Middleware\SoloInspector::class,
        'solosecretaria' => \App\Http\Middleware\SoloSecretaria::class,
